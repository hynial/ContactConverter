package com.hynial.contactconverter.util;
...
//            Files.writeString(Paths.get(outPath), content, StandardCharsets.UTF_8, StandardOpenOption.APPEND); // 11+
            Files.write(Paths.get(outPath), content.getBytes(StandardCharsets.UTF_8), StandardOpenOption.APPEND);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void writeFile(String outPath, String content) {
        try {
            ...
            Files.write(Paths.get(outPath), content.getBytes(StandardCharsets.UTF_8), StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void appendFile(String outPath, String content){
        try {
            ...
            Files.write(Paths.get(outPath), content.getBytes(StandardCharsets.UTF_8), StandardOpenOption.CREATE, StandardOpenOption.APPEND);
