...
public class VcfReader extends AbstractReader<ContactsInfo> {
    ...
    private void reform(List<ContactsInfo> contactsInfoList){
        if(contactsInfoList == null) return ;
        for(ContactsInfo contactsInfo : contactsInfoList){
            ...
            if(CommonUtil.isEmpty(lastName) && CommonUtil.isNotEmpty(firstName)){
                ...
                if(!CommonUtil.containsHanScript(firstName)) continue;
